...
def get_beta(theta_11, theta_21, r=between_cameras): # Now irrelevant but a backup function (not complete)
...
def get_theta_3t(theta_11, theta_12, theta_21, r=between_cameras, m=between_tapes):
...
def get_distance_3t(theta_11, theta_12, theta_21, r=between_cameras, m=between_tapes):
    k_2 = (math.pi/2) - theta_21
    k_3 = math.pi - (math.pi/2.0 + theta_11) - k_2
    d_11 = r * (math.sin(k_2) / math.sin(k_3))
    k_6 = theta_11 - theta_12
...
# ANGLES TO THE LEFT MUST BE POSITIVE, ANGLES TO THE RIGHT MUST BE NEGATIVE
def get_theta_2t1d(theta_11, theta_12, d_11, r=between_cameras, m=between_tapes):
    k_6 = theta_11 - theta_12
    print("gt k6:", k_6 * (180.0/math.pi))
    print("gt k11 inp:", (d_11 * math.sin(k_6)) / m)
    k_11 = math.asin((d_11 * math.sin(k_6)) / m)
...
def get_distance_2t1d(theta_11, theta_12, d_11, r=between_cameras, m=between_tapes):
    k_6 = theta_11 - theta_12
    k_11 = math.asin((d_11 * math.sin(k_6)) / m)
