...
def get_distance(theta_11, theta_12, theta_21, r=between_cameras, m=between_tapes):
    k_2 = (math.pi/2) - theta_21
    k_3 = math.pi- (math.pi/2 + theta_11) + k_2
    d_11 = r * (math.sin(k_2) / math.sin(k_3))
    k_6 = theta_11 + theta_12
    print("gd k11 inp:", (d_11 * math.sin(k_6)) / m)
    k_11 = math.asin((d_11 * math.sin(k_6)) / m)
    ...
    return D # Positive means turn left, negative means turn right
...
print(get_distance(math.pi/12, -math.pi/2, -math.pi/12, r=1, m=1))
