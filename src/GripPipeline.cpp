...
void GripPipeline::Process(cv::Mat& source0){
	...
	hsvThreshold(hsvThresholdInput, Config::HUE_RANGE, Config::SAT_RANGE, Config::VAL_RANGE, this->hsvThresholdOutput);
	//Step Find_Contours0:
	//input
	...
	double filterContoursMaxHeight = 500.0;  // default Double
